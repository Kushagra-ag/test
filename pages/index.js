                ...
                <Head>
                    ...
                    <div className="row mt-5">
                        <div className="col-12 text-center">
                            ...
                            <div className="position-absolute mx-auto" style={{left:0, right:0, zIndex: 10}}>
                                <Image
                                    className=""
                                    src="/../public/images/image1_home_demons.png" // Route of the image file
                            ...
                            <div className="mt-4 side-cards" style={{zIndex: 2}}>
                                <Image
                                    ...
                                    src="/../public/images/image2.png" // Route of the image file
                                ...
                                <Image
                                    className="ml-n2"
                                    src="/../public/images/image3.png" // Route of the image file
                                    height={406.56} // Desired size with correct aspect ratio
                                    width={375} // Desired size with correct aspect ratio
                                    alt="Your Name"
                                />
                            ...
                            <div className="gradient-angle position-relative px-md-5 px-lg-5">
                                <div className="col-md-6 text-md-left px-md-4 px-lg-5 gradient-content">
                                    <SectionHeading content="Reinventing how NFTs work" light />
                                    <div className="font-weight-light text-white py-5">
                                        We'll be incentivising people for holding NFTs. You'll be earning interests and utility for holding NFTs. Goal is to create a NFT circular economy, and we'll be the first team to ever do that to NFTs. <br/>
                                        It's a first NFT series built on Bonding curve on zilliqa Blockchain and First NFT series to be gamified. 
                                    </div>
                                </div>
                            </div>
                        </div>
