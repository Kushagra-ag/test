        ...
        <>
            ...
            <div className="row mt-5">
                <div className="col-12 text-black-medium">
                    ...
                    accumsan, quisque odio elit lectus et risus. Tristique felis
                    vel nunc mauris dolor ornare. Quis eget eu ultricies
                    faucibus facilisis ullamcorper imperdiet. Sagittis, nec hac
                    varius mollis elit arcu nunc pellentesque amet. Purus
                    lacinia nam pulvinar non sagittis sodales praesent etiam.
                    Elementum, aliquam integer sit adipiscing ac, aliquam. Lorem
                    ipsum dolor sit amet, consectetur adipiscing elit. Sem
                    accumsan, quisque odio elit lectus et risus. Tristique felis
                    vel nunc mauris dolor ornare. Quis eget eu ultricies
                    faucibus facilisis ullamcorper imperdiet. Sagittis, nec hac
                    varius mollis elit arcu nunc pellentesque amet. Purus
                    lacinia nam pulvinar non sagittis sodales praesent etiam.
                    Elementum, aliquam integer sit adipiscing ac, aliquam.
                </div>
            </div>
        </>
    );
